...
namespace Sholo.Mqtt.Old.Topics.Filter
{
    public interface IMqttTopicFilter
    {
        ...
        /// <summary>
        /// Gets a flag that requests for the broker to not send application messages forwarded with a ClientID equal to the ClientID of the publishing connection.
        /// </summary>
        bool? NoLocal { get; }

        /// <summary>
        /// Gets a flag that indicates whether application messages forwarded using this subscription keep the retain flag they were published with.
        /// </summary>
