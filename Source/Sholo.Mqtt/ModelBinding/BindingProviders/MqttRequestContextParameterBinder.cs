...
public class MqttRequestContextParameterBinder : IMqttParameterBinder
{
    public bool TryBind(
    ...
    {
        if (parameterState.TargetType == typeof(IMqttRequestContext))
        {
            result = new ParameterBindingResult(MqttBindingSource.Context, requestContext, bypassValidation: true);
            return true;
        }
