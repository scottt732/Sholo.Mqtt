...
namespace Sholo.Mqtt
{
    public class RouteProvider : IRouteProvider
    {
        ...
        {
            parameterBindingContext.GetHashCode();
        ...
        private bool TryBindService(ParameterBindingContext parameterBindingContext)
        {
            var argumentValues = parameterBindingContext.Request.ServiceProvider
                .GetServices(parameterBindingContext.ActionParameter.ParameterType)
                .ToArray();
        ...
        private bool TryBindPayload(PayloadBindingContext payloadBindingContext)
        {
            ...
            var typeConverter = explicitTypeConverter ?? payloadBindingContext.PayloadTypeConverter;

            if (!typeConverter.TryConvertPayload(payloadBindingContext.Request.Payload, parameterType, out var payload))
            {
                return false;
            }

            payloadBindingContext.Payload = payload;
            return true;
        }
