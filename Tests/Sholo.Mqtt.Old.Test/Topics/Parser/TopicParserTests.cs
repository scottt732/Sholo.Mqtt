using System;
using Sholo.Mqtt.Old.Topics.Parser;
using Xunit;
using Xunit.Abstractions;

namespace Sholo.Mqtt.Old.Test.Topics.Parser
{
    public class TopicParserTests
    {
        ...
        [InlineData("sensor/data/foo/#", "sensor/data/foo/abc/a13re/abc", true)]
        [InlineData("sensor/data/foo/#", "sensor/data/foo/abc", true)]
        [InlineData("sensor/+/bar/#", "sensor/foo/bar/baz/abc/json", true)]
